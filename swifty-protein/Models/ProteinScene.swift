...
//  swifty-protein
//
//  Created by Colin Schmitt on 03/03/2021.
//
...
class ProteinScene: SCNScene, SCNNodeRendererDelegate{
    ...
    init(pdbFile: String) {
        ...
        for line in protein {
            ...
            if splitedLine[0] == "ATOM"{
                ...
                sphereGeometry.firstMaterial?.diffuse.contents = sphColor(atomName: String(splitedLine[11]))
    ...
    func sphColor(atomName:String)->UIColor{
